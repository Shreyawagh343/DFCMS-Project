...
const DashboardCard = () => {
  return (
    <>
      ...
      <div className="card bg-base-100 w-[17rem] h-32 shadow-md ml-10 mt-10 dark:bg-slate-900 dark:text-white">
        <div className="flex">
          <h2 className="card-title text-gray-400 text-xl ml-5 mt-5">Total Cases</h2>
         </div>
          <p className="font-semibold text-2xl ml-5 mt-2">432</p>
      ...
      <div className="card bg-base-100 w-[17rem] h-32 shadow-md ml-10 mt-10 dark:bg-slate-900 dark:text-white">
        <div className="flex">
          ...
          <p className="font-semibold text-2xl ml-5 mt-2">250</p>
      ...
      <div className="flex">
          ...
          <p className="font-semibold text-2xl ml-5 mt-2">182</p><p className="font-semibold text-1xl ml-5 mt-2"><span className="text-red-700">+5% </span>less than last week</p>
      </div>
      <div className="card bg-base-100 w-[17rem] h-32 shadow-md ml-10 mt-10 dark:bg-slate-900 dark:text-white">
      <div className="flex">
          <h2 className="card-title text-xl text-gray-400 ml-5 mt-5">Ongoing Cases</h2>
         </div>
          <p className="font-semibold text-2xl ml-5 mt-2">100</p>
